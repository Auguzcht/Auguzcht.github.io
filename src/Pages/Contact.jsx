  ...
  return (
    <>
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        ...
        >
          "Don’t be a stranger—hit me up! I’ll be sure to get back to you."
        </p>
      </div>
        ...
        <div className="container px-[1%] grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-[45%_55%] 2xl:grid-cols-[35%_65%] gap-12">
          ...
          >
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <p className="text-gray-400">
                  Got something on your mind? Drop me a message and let's hear it!
                </p>
              </div>
            ...
            >
              ...
              <input type="hidden" name="access_key" value="149a6de3-e80b-4e27-899e-1879a92688c5"></input>
